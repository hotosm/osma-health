        ...
        return (
            <div className='about-page'>
                ...
                <section className='section__body'>
                  <div className='inner'>
                    <img src='images/chobe.png' alt="Analytics for Chobe District, Botswana"></img>
                    ...
                    <h4>1. Attribute Completeness</h4>
                    <img src='images/attribute.png' alt="Attribute Completeness"></img>
                    <div className='prose'>
                    ...
                    <h4>2. Relative Completeness</h4>
                    <img src='images/completeness.png' alt="Relative Completeness"></img>
                    <div className='prose'>
